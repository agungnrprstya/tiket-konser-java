...
public class TugasBesar02PersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "TugasBesar02";
	...
	private TugasBesar02PersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new TugasBesar02PersistentManager();
		}
